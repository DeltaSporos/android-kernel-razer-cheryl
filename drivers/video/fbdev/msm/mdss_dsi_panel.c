			...
			struct mdss_panel_timing *timing)
{
	...
	ctrl->ambient_idle_on_cmds = pt->ambient_idle_on_cmds;
	ctrl->ambient_idle_off_cmds = pt->ambient_idle_off_cmds;
	ctrl->ie_sre_cmds = pt->ie_sre_cmds;
